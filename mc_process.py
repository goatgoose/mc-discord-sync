...
from mc_event import Event, PlayerMessage, PlayerJoin, PlayerLeave, Shutdown, List, Trigger
...
class MCProcess:
    def __init__(self, command):
        ...
        self.process = None
        self.line_buffer = []
        self.events = [PlayerMessage, PlayerJoin, PlayerLeave, Shutdown, List, Trigger]
